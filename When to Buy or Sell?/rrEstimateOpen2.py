...
if __name__ == "__main__":
    ...
    file = sys.argv[1]	  # input file priceMat
    ...
    for m in range(Mmin, Mmax, 1):
        ...
        for n in range(Nmin, Nmax,1):
            print("n=%d" %(n))
            actionMat = myOptimAction(priceMat, transFeeRate, m, n)	# Obtain the suggested action
            ...
            if rr > bestrr:
                ...
                bestm = m
                bestn = n    
    print("bestsetting: rr=%f%%"  %(bestrr/10000))
    print("bestsetting: m=%d"   %(bestm))
    print("bestsetting: n=%d"   %(bestn))
